...
{{%panel theme="danger"%}}
_Shamelessly copied on `2017-11-16`, as-it-is, from [here](https://docdock.netlify.com/). <-- Newer changes may be there._

Note: some features of the documentation ___may___ be broken. Refer the [original](https://docdock.netlify.com/) for complete information.
{{%/panel%}}
